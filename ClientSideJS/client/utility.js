...
export function getEntityForwardPosition(entity, scale) {
 ...
 */ export function getClosestPlayer(player) {
    return getClosestVectorFromGroup(player.pos, [
        ...alt.Player.all
    ]);
}
/**
...
export function getEntityFrontPosition(entityHandle) {
...
export function getEntityRearPosition(entityHandle) {
    let modelDimensions = native.getModelDimensions(native.getEntityModel(entityHandle), undefined, undefined);
    return this.getOffsetPositionInWorldCoords(entityHandle, new alt.Vector3(0, modelDimensions[1].y, 0));
}
export function getOffsetPositionInWorldCoords(entityHandle, offset) {
