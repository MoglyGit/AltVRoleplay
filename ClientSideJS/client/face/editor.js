...
function charCreate(zoom, x, y, z, r) {
    showCursor(true);
    alt.setMeta('noInv', '1');
...
function handleClientSync(data) {
    ...
    native.setPedHeadBlendData(cloneId, data.shapeFirstID, data.shapeSecondID, data.shapeThirdID, data.skinFirstID, data.skinSecondID, data.skinThirdID, data.shapeMix, data.skinMix, data.thirdMix, data.isParent);
}
function closeView() {
