...
function ShowTacho(maxfill) {
    ...
    if (!player.vehicle || !player.vehicle.hasSyncedMeta('Fill')) {
        ...
        if (veh.model == alt.hash('bmx') || veh.model == alt.hash('cruiser') || veh.model == alt.hash('fixter') || veh.model == alt.hash('scorcher') || veh.model == alt.hash('tribike') || veh.model == alt.hash('tribike2') || veh.model == alt.hash('tribike3')) return;
