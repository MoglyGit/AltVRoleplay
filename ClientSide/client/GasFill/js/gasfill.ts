...
alt.on('setInfos', (maxAdd, price) => {
    (<HTMLInputElement>document.getElementById('f0')).value = 'Benzin (' + price[0] + '$)';
    (<HTMLInputElement>document.getElementById('f1')).value = 'Diesel (' + price[1] + '$)';
    (<HTMLInputElement>document.getElementById('f2')).value = 'Petrol (' + price[2] + '$)';
    (<HTMLInputElement>document.getElementById('f3')).value = 'Elektro (' + price[3] + '$)';
    fillPrice = price;
...
function setFillPrice(price, fill: number) {
