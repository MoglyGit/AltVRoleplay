...
export let checkpointPos: Vector3 = null;
export let checkpointId = null;
export let checkpointYaw: number = null;
export let checkpointYawRange: number = null;
...
function SetCheckpoint(x: number, y: number, z: number, yaw: number, yawRange: number) {
