...
function createCrime()
{
  ...
  let e = (<HTMLInputElement>document.getElementById("crime"));
  ...
  {
    let price = 0, time=0;
    if((<HTMLInputElement>document.getElementById("grad")).value == "1"){ price = 150; time = 60*3;}
    if((<HTMLInputElement>document.getElementById("grad")).value == "2"){ price = 300; time = 60*5;}
    if((<HTMLInputElement>document.getElementById("grad")).value == "3"){ price = 1000; time = 60*10;}
    if((<HTMLInputElement>document.getElementById("grad")).value == "4"){ price = 3000; time = 60*30;}
    if((<HTMLInputElement>document.getElementById("grad")).value == "5"){ price = 5000; time = 60*60;}
