...
import './inventory/typescript';
import './login/typescript';
import './face/editor';
import './TextLabel/3DText';
import './Vehicle/veh';
import './Vehicle/marquisInterior';
import './Vehicle/boattrailer';
import './Vehicle/flatbed';
import './Hud/time';
import './Entity/entity';
import './Perso/typescript';
import './Licenses/typescript';
import './MDC/typescript';
import './MousePointer/mouse';
import './Bank/typescript';
import './CarRegister/typescript';
import './Apartment/typescript';
import './Notification/notification';
import './Sync/sync';
import './Sync/BoatAnker';
import './Sync/Gurt';
import './Sync/VehicleBoost';
import './DrivingLicense/typescript';
import './Tacho/tacho';
import './CarSell/main';
import './perioisland';
import './weather';
...
import './PlayerFriends/Friends';
import './WeaponShop/typescript';
import './IronFarm/startup';
import './Fishing/startup';
import './RemoveObjects/startup';
import './Factions/Garbage/main';
import './Store247/main';
import './Store247/main_owned';
import './Store247/main_buyitem';
import './Dealer/main';
import './Gasstation/main';
import './GasFill/main';
import './Firmen/main';
import './Firmen/CarDealer/carDealermain';
import './Firmen/CarDealer/carDealerMenuMain';
import './Firmen/Konto/main';
import './Firmen/Name/main';
import './Firmen/Tuner/main';
import './Firmen/Mechanic/MechanicMenu';
import './Firmen/WorkerList/main';
import './InteractionMenu/main';
import './InteractionMenuVehicle/main';
...
function CreateAppartment(positio: Vector3, interior: number, rent: number, name: string) {
...
function PlaySound(sound: string, ref: string) {
    native.playSoundFrontend(-1, sound, ref, true);
}

function blockPlayerInventory(state: boolean) {
...
function tpToWaypoint() {
    ...
    if (native.doesBlipExist(waypoint)) {
        ...
        setTimeout(() => {
            groundZ = native.getGroundZFor3dCoord(
...
function changeBlipName(x: number, y: number, oldname: string, newname: string) {
