...
function PlayerInteraction(item) {
    ...
    if (interactPlayer_Name.includes('Unbekannt'))
        (<HTMLInputElement>document.getElementById('friendButton')).value = 'Freund hinzufügen';
    else (<HTMLInputElement>document.getElementById('friendButton')).value = 'Freund entfernen';
}
...
function AddFriend() {
    ...
    if (add) {
        (<HTMLInputElement>document.getElementById('friendButton')).value = 'Freund entfernen';
...
function Anim(dic: string, name: string, inb: number, out: number, flag: number, lock: boolean, invBlock = false) {
...
function setInPText(state: number) {
...
function givePlayerMoney(ev) {
    ...
    document.getElementById('playerGiveMoney').style.visibility = 'hidden';
    document.getElementById('playerGiveMoney').style.display = 'none';
    const money = (<HTMLInputElement>document.getElementById('moneyTransfer')).value;
...
alt.on('bodyInfo', (height: number, eyeCo: string) => {
